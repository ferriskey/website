...
This module makes FerrisKey the IdP that other applications trust. Signing in *through* an external SAML provider is a different problem, handled by federation in [Abyss](/en/modules/abyss/overview), and it is not shipped yet.
:::
