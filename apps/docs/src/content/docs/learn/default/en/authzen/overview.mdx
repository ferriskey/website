...
OAuth2 and OIDC handle authentication and coarse-grained delegation. They don't really handle authorization, in the sense of _"can this specific user do this specific thing to this specific resource right now?"_
