...
OpenID Connect (OIDC) is a thin identity layer on top of OAuth2. Where OAuth2 answers _"what is this token allowed to do?"_, OIDC tacks on _"and, by the way, who is the user?"_
