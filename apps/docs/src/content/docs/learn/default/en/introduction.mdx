...
FerrisKey implements OAuth2, OIDC, JWT and SAML. AuthZen is the exception: FerrisKey issues the identity and coarse-grained authorization an AuthZen engine consumes, but does not yet speak the protocol itself. To see the rest in practice:
