...
The discovery endpoint is the URL an OpenID Connect application uses to learn how to talk to FerrisKey.
...
This is why many applications only ask for an **issuer**, **authority**, or **discovery URL** instead of asking you to configure every endpoint manually.
